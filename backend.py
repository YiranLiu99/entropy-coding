...
def upload_image_and_huffman_compress_decompress():
    ...
    huffman_image.save_decompressed_image('uploads/huffman/huffman_compressed_' + file_name + '.bin',
                                          'uploads/huffman/')
...
def upload_image_and_shannon_compress_decompress():
    ...
    print('Decompressing the image...')
    shannon_fano_image.save_decompressed_image('uploads/sf/sf_compressed_' + file_name + '.bin',
                                               'uploads/sf/')
